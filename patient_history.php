    ...
    <div class="container" style="margin-left: 5%;">
        ...
        <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT medical_history.date, CONCAT(doctors.first_name, ' ', doctors.last_name) AS doctor_name, CONCAT(patients.first_name, ' ', patients.last_name) AS patient_name, medical_history.diagnosis, medical_history.treatment, medical_history.notes
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='5'>No medical history found.</td></tr>";
                    }
