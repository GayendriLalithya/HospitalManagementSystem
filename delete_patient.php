...
<body>
    ...
    <div id="mySidenav" class="sidenav" class="background">
        ...
        <b><p><a href="insert_patient.php">Insert Patient</a><br/>
    ...
    <div class="container" style="margin-left: 38%;">
        ...
        <form method="POST" action="delete_patient.php" name="patreg" onsubmit="return checkpasswordmem()" autocomplete="off" enctype="multipart/form-data">
            <div class="row">
