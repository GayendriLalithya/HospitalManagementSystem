    ...
    if (isset($_POST["update"])) {
        ...
        try {
            ...
            echo "<script type='text/javascript'>
                    alert('Error! Schedule update is unsuccessful. Foreign key constraint violation.');
                    window.location.href = 'nurse_edit_schedule.php';
                  </script>";
            exit();
        }
        ...
        if (mysqli_stmt_affected_rows($stmt) > 0) {
            echo "<script type='text/javascript'>
                    ...
                    window.location.href = 'nurse_schedule.php';
                  </script>";
        } else {
            echo "<script type='text/javascript'>
                    alert('Error! Schedule update is unsuccessful: " . mysqli_stmt_error($stmt) . "');
                    window.location.href = 'nurse_edit_schedule.php';
                  </script>";
        }
        ...
        try {
            ...
            echo "<script type='text/javascript'>
                    alert('Error! Schedule deletion is unsuccessful. Foreign key constraint violation.');
                    window.location.href = 'nurse_edit_schedule.php';
                  </script>";
            exit();
        }
        ...
        if (mysqli_stmt_affected_rows($stmt) > 0) {
            ...
            echo "<script type='text/javascript'>
                    alert('Error! Schedule deletion is unsuccessful: " . mysqli_stmt_error($stmt) . "');
                    window.location.href = 'nurse_edit_schedule.php';
                  </script>";
        }
    }
...
<head>
    ...
    <title>Nurse | Edit Schedules</title>
...
<div class="main-content">
    <div class="sidenav">
        ...
        <p><a href="nurse_schedule.php">View Schedules</a></p>
        <p><a href="nurse_create_schedule.php">Create Scedules</a></p>
    ...
    <div class="container" style="margin-left: 5%; ">
        ...
        <label for="schedule-id">Schedule ID:</label>
            <input type="number" id="schedule-id" name="schedule_id" style="margin-bottom: 20px;">
            ...
            <button id="update" type="submit" name="update">Update Schedule</button>
            <button id="delete" type="submit" name="delete" class="red-btn">Delete Schedule</button>
        </form>
    </div>
</div>
