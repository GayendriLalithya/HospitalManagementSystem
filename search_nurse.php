...
$search = isset($_POST['search_nurses']) ? $_POST['search_nurses'] : '';

$sql = "SELECT * FROM nurses WHERE first_name LIKE '%$search%' OR last_name LIKE '%$search%' OR email LIKE '%$search%'";
...
<head>
    ...
    <title>Admin | Search Nurses</title>
...
<div class="sidenav">
        ...
        <b><p><a href="view_nurse.php">View All Nurses</a><br/>
