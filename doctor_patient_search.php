...
<div class="sidenav">
    ...
    <p><a href="doctor_dashboard.php">Dashboard</a><br/>
    <p><a href="doctor_patient_insert.php">Add Patient</a><br/>
    <p><a href="doctor_patient_update.php">Update Patient</a><br/>
    <p><a href="doctor_patient_delete.php">Delete Patient</a><br/>
    <p><a href="doctor_patient_view.php">View All patients</a><br/>
...
<div class="main-content">
    <div class="container" style="margin-left: 5%;">
        <div class="search-container">
            <form action="doctor_patient_search.php" method="POST">
