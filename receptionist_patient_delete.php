...
<head>
    ...
    <title>Receptionist | Delete Patient</title>
...
<body>
    ...
    <div id="mySidenav" class="sidenav" class="background">
        ...
        <b><p><a href="receptionist_patient_view.php">View Patients</a><br/>
        <b><p><a href="receptionist_patient_insert.php">Insert Patient</a><br/>
        <b><p><a href="receptionist_patient_update.php">Update Patient</a><br/>
        <b><p><a href="logout.php">Logout</a><br/>    
    </div> 

    <div class="container" style="margin-left: 38%;">
        <h1>Delete Patient</h1>
        <form method="POST" action="receptionist_patient_delete.php" name="patreg" onsubmit="return checkpasswordmem()" autocomplete="off" enctype="multipart/form-data">
            <div class="row">
