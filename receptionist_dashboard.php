        ...
        <section id="services" class="key-features department">
            <div class="container">
                <div class="inner-title" style="font-size: 4rem;">
                    ...
                    <h2 style="font-size: 4rem;">Receptionist Dashboard</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="room.php" class="single-key-link">
                            <div class="single-key">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="receptionist_patient_view.php" class="single-key-link">
                            <div class="single-key">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="receptionist_appointment.php" class="single-key-link">
                            <div class="single-key">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="payments_view.php" class="single-key-link">
                            <div class="single-key">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="invoice_view.php" class="single-key-link">
                            <div class="single-key">
