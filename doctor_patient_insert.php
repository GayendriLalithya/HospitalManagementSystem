...
<body>
    ...
    <div id="mySidenav" class="sidenav" class="background">
        ...
        <b><p><a href="doctor_patient_delete.php">Delete Patient</a><br/>
        <b><p><a href="logout.php">Logout</a><br/>    
    </div> 

    <div class="container" style="margin-left: 38%;">
        <h1>Add Patient</h1>
        <form method="POST" action="doctor_patient_insert.php" name="patreg" onsubmit="return checkpasswordmem()" autocomplete="off" enctype="multipart/form-data">
